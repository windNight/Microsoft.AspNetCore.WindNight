...
namespace WindNight.NetCore.Core.Tools
{
    public static class RetryFunc
    {
        ...
        /// <param name="delayms">the <see cref="delayms" /> milliseconds wait re-exec the main func</param>
        ...
        public static T RetrySnippetFunc<T>(
            ...
            Action rollBackAction = null, Action<Exception> warnAction = null
        )
        {
